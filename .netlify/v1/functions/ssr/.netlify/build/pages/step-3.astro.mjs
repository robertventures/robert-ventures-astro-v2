...
const $$Step3 = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate(_a || (_a = __template(['<html lang="en" data-astro-cid-2mcmjpbp> <head>', `<!-- Meta Pixel Code --><!-- <script is:inline>
...
<\/script></body></html>`], ['<html lang="en" data-astro-cid-2mcmjpbp> <head>', `<!-- Meta Pixel Code --><!-- <script is:inline>
            !(function (f, b, e, v, n, t, s) {
                if (f.fbq) return;
                n = f.fbq = function () {
                    n.callMethod
